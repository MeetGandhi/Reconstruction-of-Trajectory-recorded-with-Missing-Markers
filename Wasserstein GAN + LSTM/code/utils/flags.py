...
def home_out(path):
  return pjoin('/gdrive','My Drive','home', 'tmp', 'MoCap', path) #pjoin(os.environ['HOME'], 'tmp', 'MoCap', path)
...
flags.DEFINE_integer('chkpt_num' , 40380, 'Number of the checkpoint')
...
flags.DEFINE_list('gen_layers', [123, 30, 123], 'Number of units in each layer of generator')
flags.DEFINE_list('dis_layers', [123, 30, 1], 'Number of units in each layer of discriminator')
flags.DEFINE_float('variance_epsilon', 0.005, 'For Batch-Normalization')

flags.DEFINE_integer('n_gen_hidden', 1024, 'Number of units in each hidden layer of generator')
flags.DEFINE_integer('n_dis_hidden', 1024, 'Number of units in each hidden layer of discriminator')
flags.DEFINE_integer("g_num_layers", 1, "Number of hidden layers in generator")
flags.DEFINE_integer("d_num_layers", 1, "Number of hidden layers in discriminator")
flags.DEFINE_boolean("train_state", True, "In Batch Normalization")
...
flags.DEFINE_string('data_dir',#'/home/taras/Documents/storage/CMU_Mocap/C3D/30k_90L',
		    ...
		    #'/home/taras/Documents/Datasets/MoCap/C3d/Raw/30k_90L',
                    # pjoin('/gdrive','My Drive','home', 'data', '30k_90L'),
                    pjoin('data', '30k_90L'),
