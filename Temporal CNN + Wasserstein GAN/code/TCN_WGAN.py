##Our RMSE for basketball is :  14.111891878288604
##
##Our RMSE for boxing is :  24.560320101917313
##
##Our RMSE for the jump turn is :  23.577073249845366
...
##The training was running for 709.060  min
...
##
##Our RMSE for boxing is :  11.209650262968276
...
##
##Our RMSE for basketball is :  14.100846686440885
    ...
    def __init__(self, shape, sess, batch_size, variance_coef, data_info):
        ...
        with sess.graph.as_default():
            ...
            with tf.variable_scope("AE_Variables"):
                ...
                self._valid_output = self.construct_gen_graph(self._valid_input_, 1)
    ...
    def construct_gen_graph(self, input_seq_pl, dropout):
        ...
        if FLAGS.reccurent is False:
           ...
           with tf.variable_scope("gen") as gen:
              ...
              g_res = Dense(123)(g_res)
              g_res = Activation('relu')(g_res)
              ...
              g_output = tf.reshape(g_output, [self.batch_size, FLAGS.chunk_length,
                                              FLAGS.frame_size * FLAGS.amount_of_frames_as_input])
